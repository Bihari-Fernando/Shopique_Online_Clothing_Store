...
class ProductController extends Controller
{
    ...
    {
        return response()->json(WomenProduct::all());
    }

    public function getMenProducts()
    {
        return response()->json(MenProduct::all());
    }

    public function getKidsProducts()
    {
        return response()->json(KidsProduct::all());
    }

    public function getAccessoriesProducts()
    {
        return response()->json(AccessoriesProduct::all());
    }

    ...
    <div className="container mx-auto my-10 px-4 md:px-10">
      <div className="flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-lg">Price: <span className="font-semibold">${product.price}</span></p>
          <p className="text-lg">Size: <span className="font-semibold">{product.size}</span></p>
          <p className="text-lg">Color: <span className="font-semibold">{product.color}</span></p>
